...
import os
from sis.site_config import site_static_path

onLinux = os.uname()[0]=='Linux'
...
ADMINS = (
     ('NWCS Webmaster', 'webmaster@nwcsny.org'),
)
...
if DEBUG:
    ...
    DATABASES = {
     'default': {
        ...
        'NAME': 'csis',                      # Or path to database file if using sqlite3.
        'USER': 'root',                      # Not used with sqlite3.
        'PASSWORD': '<not the actual password>',                  # Not used with sqlite3.
        'HOST': '',                      # Set to empty string for localhost. Not used with sqlite3.
        'PORT': '',                      # Set to empty string for default. Not used with sqlite3.
     }
    }
...
SECRET_KEY = '7%u6=8+sno-45j$n5a!2vwlzuge%jzyyo4$hn^u!gwzrx(u8mq'
...
TEMPLATE_DIRS = (
    here('templates'),
    #'/Users/charlesperng/nwcscode/sis/dev/sis/templates',
...
AUTH_PROFILE_MODULE = 'core.Family'
