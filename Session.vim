...
silent only
cd ~/nwcscode/sis/dev/sis
if expand('%') == '' && !&modified && line('$') <= 1 && getline(1) == ''
  let s:wipebuf = bufnr('%')
endif
set shortmess=aoO
badd +1 urls.py
badd +43 core/models.py
badd +156 core/views.py
badd +9 templates/semester.html
badd +1 core/forms.py
badd +1 templates/enroll.html
badd +1 core/adddata.py
silent! argdel *
edit core/models.py
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 177 - ((23 * winheight(0) + 28) / 56)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
177
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 96 - ((12 * winheight(0) + 27) / 55)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
96
normal! 01l
tabedit core/forms.py
set splitbelow splitright
set nosplitbelow
set nosplitright
wincmd t
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 53 - ((40 * winheight(0) + 26) / 53)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
53
normal! 0
tabedit templates/enroll.html
set splitbelow splitright
set nosplitbelow
set nosplitright
wincmd t
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 26 - ((7 * winheight(0) + 28) / 56)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
26
normal! 013l
tabedit templates/semester.html
set splitbelow splitright
set nosplitbelow
set nosplitright
wincmd t
